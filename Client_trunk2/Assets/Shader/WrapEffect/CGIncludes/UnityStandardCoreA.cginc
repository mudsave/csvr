...
#include "UnityStandardConfigA.cginc"
#include "UnityStandardInputA.cginc"
#include "UnityPBSLighting.cginc"
#include "UnityStandardUtilsA.cginc"
#include "UnityStandardBRDFA.cginc"
...
VertexOutputForwardBase vertForwardBase (VertexInput v)
{
	...
	warp.Size = _Size;	
	float4 outPos = ApplyWarp( posWorld, warp);
	o.pos = mul(UNITY_MATRIX_VP, outPos);
