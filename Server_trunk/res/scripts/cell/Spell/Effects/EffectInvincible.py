...
class EffectInvincible(SpellEffect):
	"""
	无敌效果
	"""
	def init(self, dataSection):
		...
		#无敌状态的得失，0：失去，1：获得
		self.invincible = dataSection.readInt("param1")
	...
	def cast(self, src, dst, spell):
		...
		if self.invincible == 0:
			dst.effectStatusCounterDecr(eEffectStatus.Invincible)
		if self.invincible == 1:
			dst.effectStatusCounterIncr(eEffectStatus.Invincible)
